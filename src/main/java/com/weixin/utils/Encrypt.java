...
public class Encrypt {
	...
	public static void main(String[] args) {
		...
		String data = "{'openid':'oAl3ejhR7h0Cf9XzNmu85yWWEUDY'}";
	...
	private static final String firstKey = "cpic";
	private static final String secondKey = "taibao";
	private static final String thirdKey = "khzzfw";
